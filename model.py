...
training_accuracy = history.history['accuracy']  # or 'acc' depending on your Keras version
validation_accuracy = history.history['val_accuracy']  # or 'val_acc'

# Access training and validation loss from the history object
training_loss = history.history['loss']
validation_loss = history.history['val_loss']

# Print or use the accuracy and loss as needed
